...
<script src="bootstrap/js/bootstrap.min.js"></script>
  ...
  <%
		...
		ResultSet resultset = null;
			...
			myStmt = connection.prepareStatement("select * from mieszkanie JOIN blok on mieszkanie.id_bloku=blok.id_bloku where mieszkanie.id_bloku=?");
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-12">
				<h4>Mieszkania w Bloku id: <%= record %></h4>
